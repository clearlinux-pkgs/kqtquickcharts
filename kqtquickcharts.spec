...
Version  : 22.04.2
Release  : 39
URL      : https://download.kde.org/stable/release-service/22.04.2/src/kqtquickcharts-22.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/kqtquickcharts-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/kqtquickcharts-22.04.2.tar.xz.sig
...
%prep
%setup -q -n kqtquickcharts-22.04.2
cd %{_builddir}/kqtquickcharts-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654828476
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kqtquickcharts-22.04.2/COPYING %{buildroot}/usr/share/package-licenses/kqtquickcharts/f425e50e051b87590a5c1ac4d6f52506ff12d134
pushd clr-build
%make_install
popd
