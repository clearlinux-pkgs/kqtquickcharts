...
Source0  : https://download.kde.org/stable/release-service/20.08.0/src/kqtquickcharts-20.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.0/src/kqtquickcharts-20.08.0.tar.xz.sig
...
%prep
%setup -q -n kqtquickcharts-20.08.0
cd %{_builddir}/kqtquickcharts-20.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597792140
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kqtquickcharts-20.08.0/COPYING %{buildroot}/usr/share/package-licenses/kqtquickcharts/f425e50e051b87590a5c1ac4d6f52506ff12d134
pushd clr-build
%make_install
popd
